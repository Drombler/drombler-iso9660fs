...
//                 release {
                    ...
                    sh 'mvn -B -e -Dmaven.test.failure.ignore=true gitflow:release-finish -DperformRelease=true -DversionDigitToIncrement=${versionDigitToIncrement} -DpostReleaseGoals="deploy -DperformRelease=true"'
//                 }
            }
        }
    }
